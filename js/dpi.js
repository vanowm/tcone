//https://github.com/shutterstock/changeDPI/blob/master/dist/index.js
"use strict";
(function (exports)
{
...
let pngDataTable = void 0;

const PNG = "image/png";
const JPEG = "image/jpeg";

// those are 3 possible signature of the physBlock in base64.
// the pHYs signature block is precede by the 4 bytes of length. The length of
...
function changeDpiDataUrl (base64Image, dpi)
{
  ...
  // to contain the information.
	...
	const base64Header = btoa(String.fromCharCode.apply(String, _toConsumableArray(finalArray)));
...
function changeDpiOnArray (dataArray, dpi, format, overwritePHYS)
{
    ...
    // this multiplication is because the standard is dpi per meter.
      ...
      // data url encoding gives me integers, for luck this chunk is 17 + 4 = 21
