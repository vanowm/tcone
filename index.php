		...
		<div class="input">
			...
			<div class="result">
				<div id="result" class="table">
					<div id="radTop"><label><span>Radius</span><label>R1</label>:</label><span></span><span></span></div>
					<div id="radBot"><label><span>Radius</span><label>R2</label>:</label><span></span><span></span></div>
